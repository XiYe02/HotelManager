...
namespace Zhaoxi.HotelRemoteControlCenter.UControls
{
    public partial class CircleButton : Button
    {
        ...
        //属性扩展：背景色1、背景色2、边框粗细、边框颜色、点击后的文字颜色、圆角半径、渐变模式
        ...
        [DefaultValue(typeof(Color), "Red"), Description("选中后的文字颜色")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.isMouseDown)
            {
                fontBrush = new SolidBrush(this.SelectedColor);
            }
            g.DrawString(Text, this.Font, fontBrush, rect2, format);
        }
    }
}
